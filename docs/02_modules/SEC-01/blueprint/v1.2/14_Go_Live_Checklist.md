...
| # | Gate | Status |
|---:|---|---|
| 1 | SEC-01 blueprint accepted | Complete |
...
| 23 | Security sign-off | Complete for blueprint acceptance |
| 24 | Compliance sign-off | Complete for blueprint acceptance |
...
| 41 | Management sign-off | Pending for implementation/go-live |
