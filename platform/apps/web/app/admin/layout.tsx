 ...
 * `/admin/edd-review`) and `2R` the fifth (Approval Queue, `/admin/approval-queue`). See `UI-04` §9/§12/§49 for the approved B-classified information
...
export const metadata: Metadata = {
  ...
  description:
    "AIX authenticated Admin/Compliance Portal — Compliance Overview, Client Risk / KYC-KYB, AML / Transaction Monitoring, EDD / Review and Approval Queue interface previews; other Admin areas are planned.",
};
