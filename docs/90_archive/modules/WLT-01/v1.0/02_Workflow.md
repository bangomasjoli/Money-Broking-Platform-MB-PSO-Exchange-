...
5. Canonicalise address.
6. Capture ownership/control evidence where required.
7. Create wallet destination record.
8. Set status to pending_screening.
...
6. Call/verify AML-01 pre-transaction gate.
7. Verify Travel Rule data completeness where required.
8. Issue short-lived destination decision token.
9. Return allow/deny/hold.
