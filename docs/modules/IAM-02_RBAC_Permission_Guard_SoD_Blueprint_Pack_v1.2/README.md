...
IAM-02 v1.2 is a non-substantive final rollup after Claude Opus final verification.

Status:
- All 5 critical gaps resolved in v1.1.
- All 7 recommended corrections resolved in v1.1.
- v1.2 fixes only cosmetic markdown/typo/heading items.
- IAM-02 is accepted / final verified.

Cosmetic fixes:
1. Markdown numbering cleaned.
2. `CFC-01` typo corrected to `CFG-01`.
3. API section heading updated to "Protected-Action / SoD APIs".
4. Status marked accepted / final verified.

No control logic changed from v1.1.
