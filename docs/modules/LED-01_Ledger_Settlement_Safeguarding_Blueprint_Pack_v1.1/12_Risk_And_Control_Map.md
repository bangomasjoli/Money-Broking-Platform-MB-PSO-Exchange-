...
|---|---|---|---|
| LED1-RISK-014 | Concurrent holds overspend | Atomic reservation/live balance version | LED1-TC-041-044 |
| LED1-RISK-015 | Single-leg DvP exposure | Two-leg linked DvP | LED1-TC-045-048 |
| LED1-RISK-016 | Backing reused/overstated | Free vs encumbered preventive backing | LED1-TC-049-053 |
| LED1-RISK-017 | Conversion leaks AIX exposure | Linked conversion + residual policy | LED1-TC-054-058 |
| LED1-RISK-018 | Ledger tampering hidden | Journal hash-chain + external anchoring | LED1-TC-059-062 |
| LED1-RISK-019 | Credit reversed after spend | Clawback/shortfall workflow | LED1-TC-063-064 |
| LED1-RISK-020 | Idempotency conflict masks fraud | Payload conflict reject | LED1-TC-065 |
| LED1-RISK-021 | Hold released while rail live | Hold pinning | LED1-TC-066 |
| LED1-RISK-022 | Operational account principal exposure | Operational bounds | LED1-TC-067-068 |
| LED1-RISK-023 | Fee/settlement inconsistency | Atomic/saga fee posting | LED1-TC-069-070 |
