...
| Pack version | v1.1 |
| Status | Revised after Claude Opus review; step-up auth, interim MFA reset approval, freeze-session revocation, per-user-class session policy, access-token binding, mid-session anomaly detection, concurrent-session controls, password-history/breached-password checks, and auth-event authority clarification added |
...
| Depends on | FND-01 Platform Foundation v1.1 accepted pack |
...
- FND-01_Platform_Foundation_Blueprint_Pack_v1.1
