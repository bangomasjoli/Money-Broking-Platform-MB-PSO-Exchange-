...
| Item | Details |
|---|---|
| Document name | 00_Licence_Scope_And_Feature_Lock_v1.3.md |
| Platform | AIX Money Broking Platform |
| Document type | SDLC Phase 0 / Licence Scope Control |
| Version | v1.3 |
| Status | Accepted for Project Charter after second principal fintech architect review corrections |
