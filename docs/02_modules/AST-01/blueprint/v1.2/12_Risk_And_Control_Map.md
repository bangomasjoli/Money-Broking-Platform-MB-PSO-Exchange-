# AST-01 — 12 Risk, Control and Regulatory Map (v1.2)
...
| **AR-24** | One `SECURITY` determination fail-closes many siblings/wrappers at once (bridged variants, wrappers) — an availability impact | Medium | Intended: derived conjunct (01 §4.7A); released only by explicit elevated review; no classification rewritten | Operational, accepted; Compliance must staff elevated reviews |
...
| Sibling/wrapper fail-closed conjunct | 17, 04 | T-LIN-08…13, T-DER-13 |
