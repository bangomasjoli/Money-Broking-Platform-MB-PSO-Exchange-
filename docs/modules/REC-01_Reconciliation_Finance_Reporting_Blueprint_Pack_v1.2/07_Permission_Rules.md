...
| `rec1.population.prove` | Run population coverage proof |
| `rec1.external_statement.ingest` | Ingest external statement |
| `rec1.external_statement.approve_exception` | Approve manual/exception statement |
| `rec1.policy.approve` | Approve tolerance/severity/rule policy |
| `rec1.report.restate` | Restate final report |
| `rec1.regulatory_obligation.manage` | Manage regulatory obligations |
| `rec1.integrity.anchor` | Anchor REC integrity records |
...
9. narrowed-scope full report.
10. external statement manual exception.
11. safeguarding sign-off.
12. tolerance/severity/rule policy approval.
13. report restatement.
14. regulatory submission marked filed.
...
## 6. v1.1 Independence Rules

1. User from money movement operations cannot solely finalise full-population reconciliation.
2. External statement uploader cannot solely certify statement completeness.
3. Safeguarding sign-off requires four-eyes.
4. Rule-policy approver cannot be sole report finaliser for first run using the rule.
5. False-positive critical break requires independent sign-off.
