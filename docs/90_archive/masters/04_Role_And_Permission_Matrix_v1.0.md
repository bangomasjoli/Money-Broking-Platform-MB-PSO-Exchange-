...
| Item | Details |
|---|---|
| Document name | 04_Role_And_Permission_Matrix_v1.0.md |
| Platform | AIX Money Broking Platform |
| Document type | SDLC Phase 2 / Access Control and Approval Matrix |
| Version | v1.0 |
| Status | Initial role and permission matrix for review |
...
### 3.5 Sensitive Read Access Logging
...
## 8. Compliance and AML Permissions
...
## 9. Travel Rule and Wallet Screening Permissions
...
## 10. Product Access, Asset, and Pair Permissions
...
## 11. OTC/RFQ and MB Spot Broking Permissions
...
6. Re-quote requires fresh client confirmation.
7. Best-execution / fair-pricing check must pass before booking.
8. No public order book, matching engine, or client-to-client matching is allowed.

---

## 12. Deposit, Withdrawal, and Payout Destination Permissions
...
| Override third-party payout block | N | N | N | N | N | OV senior only if future policy allows | N | N | N | N | N | V |
...
5. Withdrawal must pass balance, Travel Rule, AML, wallet screening, and maker-checker checks.
...
## 13. Ledger, Balance, and Settlement Permissions
...
9. Settlement sequence must not create AIX principal exposure.
10. Reconciliation breaks require owner, evidence, resolution, and audit log.

---

## 14. Client Money Safeguarding and Reconciliation Permissions
...
## 15. Vendor, LP, Custodian, and Bank Permissions
...
## 16. Reporting, Records, and Export Permissions
...
## 17. Admin, Configuration, and Feature Flag Permissions
...
| Change data retention settings | M | K/A | R security | R technical | K compliance | K AML where needed | N | N | V | V |
...
## 19. Future-Locked Exchange Permission Matrix
...
## 21. Segregation-of-Duties Conflict Matrix
...
## 22. Sensitive Action Audit Matrix
...
## 23. Permission Dependency Rules
...
9. Maker-checker is completed.
10. No SoD conflict exists.
...
6. Pre-funded hold succeeds.
7. LP execution succeeds or matched leg is confirmed.
8. Idempotency check passes.
9. Balance operation is atomic.
...
| OTC/RFQ | Client, Ops | Ops Manager, Compliance where needed |
...
| Deposit / Withdrawal | Client, Ops, Finance, Compliance | Ops Manager, Finance Manager, Compliance |
...
## 26. Testing Requirements for Permissions
...
## 27. Open Items for Module Blueprints
...
## 29. Claude Opus Review Prompt

```txt
Review this 04_Role_And_Permission_Matrix_v1.0.md as a principal fintech platform architect and regulated fintech security reviewer.
