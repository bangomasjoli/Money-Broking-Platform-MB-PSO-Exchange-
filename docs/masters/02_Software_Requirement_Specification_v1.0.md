...
1. Destination must belong to or be approved for the client.
2. Verification required.
3. New destination cooling-off required.
4. Destination changes require audit log.
5. High-risk destination changes require maker-checker.
6. Withdrawal cannot proceed to unverified destination.
7. Wallet destination must link to wallet screening and Travel Rule.
8. Bank destination must link to client bank account evidence.
...
```txt
Review this 02_Software_Requirement_Specification_v1.0.md as a principal fintech platform architect.
