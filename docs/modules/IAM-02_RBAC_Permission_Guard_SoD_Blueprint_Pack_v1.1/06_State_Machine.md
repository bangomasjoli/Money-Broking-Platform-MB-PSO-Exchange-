...
stateDiagram-v2
  ...
  issued --> expired
  issued --> revoked
  issued --> stale_cache_blocked
  issued --> payload_mismatch_blocked
  consumed --> [*]
```

## 9. Protected Action Registry State
...
stateDiagram-v2
  ...
  registered --> active
  active --> inactive
  active --> orphan_detected
  orphan_detected --> blocked
  orphan_detected --> remediated
```

## 10. SoD Risk Acceptance State
