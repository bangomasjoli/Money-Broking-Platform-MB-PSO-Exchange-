...
| Item | Details |
|---|---|
| Document name | 04_Role_And_Permission_Matrix_v1.2.md |
| Platform | AIX Money Broking Platform |
| Document type | SDLC Phase 2 / Access Control and Approval Matrix |
| Version | v1.2 |
| Status | Accepted for Master Workflow Map after subsection numbering cleanup; no substantive permission change from v1.1 |
