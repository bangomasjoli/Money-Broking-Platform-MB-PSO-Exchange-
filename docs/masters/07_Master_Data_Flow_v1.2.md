...
| Item | Details |
|---|---|
| Document name | 07_Master_Data_Flow_v1.2.md |
| Platform | AIX Money Broking Platform |
| Document type | SDLC Phase 2 / Master Data Flow and Data-Control Map |
| Version | v1.2 |
| Status | Accepted for Master Technical Architecture after store-inventory consistency cleanup; Filing Package Store and Template Store added; AML-RULE-006 dependency verified against 06 v1.2 |
...
| Template Store | Product/Support/Security | Internal / Confidential | Notification templates and approved variable schema |
| Export Store | Domain Owner/Security | Restricted / Highly Restricted | Controlled exports |
| Filing Package Store | Compliance/MLRO | Highly Restricted | STR / regulatory filing package before submission |
...
```txt
Review this 07_Master_Data_Flow_v1.2.md as a principal fintech platform architect and regulated fintech data/security reviewer.
...
This v1.2 keeps the substantive v1.1 corrections and only cleans store-inventory consistency by adding Filing Package Store and Template Store. AML-RULE-006 dependency has been verified against 06_Master_System_Rules_v1.2.md. v1.1 added DF-23 Authentication / Session / MFA / OTP, DF-24 Backup / Replication / DR, DF-25 STR Filing to FIU / Regulator, DF-26 Application / Security Log and PII Scrubbing, DF-27 Notification / OTP Delivery, a complete data store inventory, on-chain node and approved FX/rate source listings, data-flow-to-rule mapping, backup residency controls, STR tipping-off controls, and FX rate lineage requirements.
