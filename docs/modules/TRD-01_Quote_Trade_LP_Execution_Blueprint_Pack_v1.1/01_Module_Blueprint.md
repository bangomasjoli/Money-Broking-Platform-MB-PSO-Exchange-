...
| Pack version | v1.0 |
| Status | Revised after Claude Opus review; contingent/atomic agency execution, fill conservation, price identity, timeout query-back, structural no-internalisation and execution-time licence-lock revalidation added |
