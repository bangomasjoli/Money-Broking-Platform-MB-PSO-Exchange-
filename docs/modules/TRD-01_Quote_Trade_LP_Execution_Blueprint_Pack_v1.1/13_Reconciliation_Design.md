...
1. Firm quote accepted where LP quote not firm/executable.
2. Client quote validity greater than LP quote validity.
3. Client fill quantity vs LP fill quantity conservation scan.
4. Client execution price vs LP/VWAP plus disclosed fee scan.
5. LP fill allocation double-use scan.
6. Quote hash LP evidence binding scan.
7. LP timeout query-back SLA scan.
8. Late fill after void/released hold scan.
9. Internal crossing/netting scan.
10. Synthetic LP fill scan.
11. CFG revalidation at execution/settlement scan.
12. Positive slippage allocation scan.
13. Best-execution record completeness scan.
14. Partial residual hold release vs LED scan.
15. Trade state version conflict scan.
16. Client confirmation vs LED actual settlement status scan.

Critical findings:

1. AIX principal pricing window.
2. Unconserved client fill.
3. Hidden spread/price identity failure.
4. Late fill settled against released hold.
5. Internalised/client-crossed trade.
6. Settlement handoff with stale CFG decision.
7. Client confirmation falsely marked settled.
