...
| System Rules `OFF-RULE-001` (items 1–8) | Closure cannot complete with balance, open trade/settlement/withdrawal, recon break, AML/STR restriction, unverified return destination, unapplied retention | Items 1–5 via LED-01 **post-barrier** attestation after the closing barrier (preventive sequence, file 02 §7); 6–8 remain client-level (CLT-01/compliance); ACC-01 also refuses closure under an active authority restriction |
