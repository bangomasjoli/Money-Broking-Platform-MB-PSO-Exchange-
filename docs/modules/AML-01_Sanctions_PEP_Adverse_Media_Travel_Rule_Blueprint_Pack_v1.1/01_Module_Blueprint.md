...
| Pack version | v1.0 |
| Status | Revised after Claude Opus review; real-time transaction sanctions gate, list SLA/interim blocking, list coverage/50pct rule, STR clock, sanctions FP governance, input-quality gate, outcome seal/freshness, PEP depth, delisting and Travel Rule threshold/sunrise added |
