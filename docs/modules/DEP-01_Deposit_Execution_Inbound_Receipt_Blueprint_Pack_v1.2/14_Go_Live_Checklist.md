...
| # | Gate | Status |
|---:|---|---|
| 1 | DEP-01 blueprint accepted | Complete |
...
| # | Gate | Status |
|---:|---|---|
| 32 | Credit-request coherent bundle revalidation defined | Complete |
| 33 | AML/WLT revocation subscription defined | Complete |
| 34 | Inbound own-source / SoF binding defined | Complete |
| 35 | SoF/SoW evidence policy defined | Complete |
| 36 | Crypto finality model defined | Complete |
| 37 | Fiat return-window finality defined | Complete |
| 38 | Provider identity/key-rotation model defined | Complete |
| 39 | File-feed completeness controls defined | Complete |
| 40 | Independent truth reconciliation defined | Complete |
| 41 | Reference/address reuse policy defined | Complete |
| 42 | Expired intent deposit policy defined | Complete |
| 43 | Amount disposition policy defined | Complete |
| 44 | Inbound Travel Rule capture defined | Complete |
| 45 | LED pending orphan control defined | Complete |
| 46 | Controlled return path defined | Complete |
| 47 | Credit-time eligibility recheck defined | Complete |
| 48 | Reversal correlation/saga binding defined | Complete |
