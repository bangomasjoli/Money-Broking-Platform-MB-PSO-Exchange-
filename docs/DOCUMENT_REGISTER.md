...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| ARC-00 | Licence Scope & Feature Lock | Platform-wide | Licence scope / feature-lock governance — AIX Institutional Digital Asset & Tokenized Securities Platform: four product pillars (Spot / OTC / Pay / RWA) plus the **AIX Exchange** securities-market capability; **build-unlocked / production-gated capability model** (`DEC-013`) with four independent states (§1.D) across five environments (§1.E); product-architecture vs regulatory-permission separation; Model A/B/C execution architecture with internal client-to-client matching a standing prohibition **in every environment**; provider-neutral counterparty model; platform-wide Asset & Instrument classification gate; build/environment/production capability matrices (§20); production activation gate and fail-closed model (§21, §21A); 1 Jan 2027 temporal rule; 21 preserved regulatory questions; `MIG-001`…`MIG-010` migration register | v1.5 | APPROVED | N/A (governance doc) | `01_masters/00_Licence_Scope_And_Feature_Lock_v1.5.md` | Unassigned | 2026-09-22 | [`01_masters/reviews/00_Licence_Scope_And_Feature_Lock_v1.5_Review.md`](01_masters/reviews/00_Licence_Scope_And_Feature_Lock_v1.5_Review.md) (promotion review, ACCEPT, 14 adversarial checks PASS, 5 findings corrected) | v1.0, v1.1, v1.2, v1.3, v1.4 (archived) | 056a10f |
| ARC-01 | Project Charter | Platform-wide | Project charter / scope — **AIX Institutional Digital Asset, Payment & RWA Platform**: four products (Spot / OTC / Pay / RWA) over one shared institutional core plus the **AIX Exchange** securities-market capability (§12A.6), target institutional architecture (§12A), programme delivery model with the repository as authoritative control plane (§15.0). Re-baselined on approved Doc 00 v1.5 and `DEC-013`: §6.3 permanent Money Broking venue prohibitions, §6.4 build-unlocked / production-gated scope, §6.5 out-of-scope products, §10.2A–E reclassified exclusions, §12.6 prohibited vs gated modules, §26.1 five-environment matrix, §27 fifteen-step build priority. All accepted governance controls preserved | v1.5 | APPROVED | N/A (governance doc) | `01_masters/01_Project_Charter_v1.5.md` | Unassigned | 2026-09-22 | [`01_masters/reviews/01_Project_Charter_v1.5_Review.md`](01_masters/reviews/01_Project_Charter_v1.5_Review.md) (promotion review, ACCEPT, 5 findings corrected, 10 adversarial checks PASS) | v1.1, v1.2, v1.3, v1.4 (archived) | 079d88c |
| ARC-02 | Software Requirement Specification | Platform-wide | Platform-wide SRS — re-baselined on Doc 00 v1.5, Charter v1.5, Module Index v1.4 and `DEC-013`. Adds §2A the **requirement state model** (`IMPLEMENTED_CAPABILITY` / `ENVIRONMENT_AVAILABILITY` / `PRODUCTION_REGULATORY_ACTIVATION`, `STATE-SRS-001..007`), §2B the five-environment model (`ENV-SRS-001..008`), and four new requirement families: `SPT-SRS-*` AIX Spot order and execution, `PAY-SRS-*` AIX Pay, `RWA-SRS-*` AIX RWA lifecycle, `EXG-SRS-*` AIX Exchange securities market including the `EXG-SRS-100` boundary. `AST-SRS-001` rewritten as the full instrument registry; `AST-SRS-001A` synthetic instruments. §19 replaced: permanent prohibitions, production-gated requirements, corrections, out-of-scope. **v1.2's base documents were three versions stale and are corrected** | v1.3 | APPROVED | N/A (governance doc) | `01_masters/02_Software_Requirement_Specification_v1.3.md` | Unassigned | 2026-09-22 | [`01_masters/reviews/02_Software_Requirement_Specification_v1.3_Review.md`](01_masters/reviews/02_Software_Requirement_Specification_v1.3_Review.md) (promotion review, ACCEPT, 6 findings corrected, 12 adversarial checks PASS) | v1.0, v1.1, v1.2 (archived) | cf96bf2 |
| ARC-03 | Master Module Index | Platform-wide | Module index / build order — re-baselined on Doc 00 v1.5, Charter v1.5 and `DEC-013`. **37 modules**: the 33 of v1.3, unrenumbered, plus four Exchange-domain modules `EXM-01` (market & instrument administration), `EXO-01` (order book & matching engine), `EXC-01` (clearing & settlement interface), `EXP-01` (participation & eligibility) — §16A. Adds §5.4 build/activation status separate from module status; splits §17 into permanent prohibitions, modules with gated activation, and out-of-product-scope; re-scopes §13's no-internal-matching statement to **MB Spot**; adds Phase F2 to the build sequence, dependency rules 5A/5B/11–14, and the Securities Exchange parallel track with a no-shared-execution-code rule. **`EXO-01` is the securities Exchange matching engine only; no MB-domain module may call it, in any environment.** No internal matching module exists for MB Spot or may be created | v1.4 | APPROVED | N/A (governance doc) | `01_masters/03_Master_Module_Index_v1.4.md` | Unassigned | 2026-09-22 | [`01_masters/reviews/03_Master_Module_Index_v1.4_Review.md`](01_masters/reviews/03_Master_Module_Index_v1.4_Review.md) (promotion review, ACCEPT, 5 findings corrected, 11 adversarial checks PASS) | v1.0, v1.1, v1.2, v1.3 (archived) | 01bfa3c |
| ARC-04 | Role & Permission Matrix | Platform-wide | RBAC / role governance — re-baselined on Doc 00 v1.5, Charter v1.5, Module Index v1.4, SRS v1.3 and `DEC-013` clause 11. Adds §3.7 **a permission never activates a capability** (access = permission AND environment availability AND product activation AND asset eligibility AND the production regulatory gate), §3.8 environment scope, §5.2A subaccount scoping, §5.4 domain roles, §19A capability activation permissions with three required checkers, eleven client-side and eight staff roles for Spot / Pay / RWA / Exchange / surveillance / classification. §22 replaced: permanent prohibitions denied to every role including SUPER_ADMIN with **no approval path**, production-gated capabilities with roles defined but activation separate, out-of-scope products with no roles. §27 gains 21 prohibited permission codes | v1.3 | APPROVED | N/A (governance doc) | `01_masters/04_Role_And_Permission_Matrix_v1.3.md` | Unassigned | 2026-09-22 | [`01_masters/reviews/04_Role_And_Permission_Matrix_v1.3_Review.md`](01_masters/reviews/04_Role_And_Permission_Matrix_v1.3_Review.md) (promotion review, ACCEPT, 6 findings corrected, 13 adversarial checks PASS) | v1.0, v1.1, v1.2 (archived) | 6d58ceb |
| ARC-05 | Master Workflow Map | Platform-wide | Cross-module workflow map — re-baselined on Doc 00 v1.5, Charter v1.5, Module Index v1.4, SRS v1.3, Role Matrix v1.3 and `DEC-013`. Adds §3.7 **the production activation gate step** (a workflow whose activation is unresolved is described in full and gated, not removed) and six workflows: `WF-30` AIX Pay merchant payment lifecycle, `WF-31` AIX RWA asset lifecycle, `WF-32` Exchange instrument admission and listing, `WF-33` Exchange trading with the §33D.4 boundary, `WF-34` capability production activation, `WF-35` instrument classification. `WF-11` retitled **AIX Spot — Client Order and Execution** and extended with the Model A client order lifecycle. `WF-29` replaced: permanently prohibited capabilities have no workflow and **no activation procedure exists**. 26 error codes added; `EXCHANGE_MODULE_LOCKED` retained unchanged | v1.3 | APPROVED | N/A (governance doc) | `01_masters/05_Master_Workflow_Map_v1.3.md` | Unassigned | 2026-09-22 | [`01_masters/reviews/05_Master_Workflow_Map_v1.3_Review.md`](01_masters/reviews/05_Master_Workflow_Map_v1.3_Review.md) (promotion review, ACCEPT, 7 findings corrected, 13 adversarial checks PASS) | v1.0, v1.1, v1.2 (archived) | 1618fdf |
| ARC-06 | Master System Rules | Platform-wide | Platform business rules — re-baselined on Doc 00 v1.5, Charter v1.5, Module Index v1.4, SRS v1.3, Role Matrix v1.3, Workflow Map v1.3 and `DEC-013`. Adds `SYS-RULE-006` build state, `SYS-RULE-007` environment state, `SYS-RULE-007A` no control relaxed in non-production, `SYS-RULE-008` regulatory activation state, `SYS-RULE-009` product/asset eligibility state, **`SYS-RULE-010` unknown regulatory production state fails closed**, `SYS-RULE-011` access is conjunctive; `LIC-RULE-002A` production-gated capabilities; `LIC-RULE-005` Exchange domain boundary; `ASSET-RULE-002` instrument classification gate; `CFG-RULE-004` production activation control; `CFG-RULE-005` non-production capability control. **`LIC-RULE-002` rewritten** from "Exchange Scope Lock ... until Exchange approval" to a permanent Money Broking venue prohibition in every environment — a strengthening; its environment-blind rule 1 is scoped to MB-domain services and order types already reclassified by Doc 00 §6 move to `LIC-RULE-002A`. 24 prohibited behaviours and 26 error codes added; `EXCHANGE_MODULE_LOCKED` retained | v1.3 | APPROVED | N/A (governance doc) | `01_masters/06_Master_System_Rules_v1.3.md` | Unassigned | 2026-09-22 | [`01_masters/reviews/06_Master_System_Rules_v1.3_Review.md`](01_masters/reviews/06_Master_System_Rules_v1.3_Review.md) (promotion review, ACCEPT, 8 findings corrected, 15 adversarial checks PASS) | v1.0, v1.1, v1.2 (archived) | cefdbe9 |
...
**ARC-00 promoted to v1.5.** `v1.5` is the authoritative Doc 00, re-baselined on `DEC-013`
(build-unlocked / production-gated capability model) with `STR-03` as its lock-review evidence
base. `v1.4` is superseded and archived at `90_archive/masters/`, unmodified; `v1.3` and earlier
remain archived. CFG-01's vendored Doc 00 baseline and its sealed hash **remain valid** — v1.5
changed neither the licence status nor the seeded prohibited-feature registry, so both hash
inputs are unchanged; the constant's version label is now two versions stale and is recorded as
`MIG-008` in Doc 00 §25.3. **No code, migration, test, seeded identifier, sealed hash or runtime
guard is changed by the v1.5 re-baseline.**
...
| STR-03 | AIX Capability Lock Review | N/A (platform-wide) | Repository-wide lock classification and migration requirement register behind `DEC-013`. Classifies 72 identified locks across documentation, governance records, seeded configuration, migrations and runtime guards as **A** development blocker, **B** production activation gate, **C** MB Spot permanent boundary, **D** product-scope prohibition, **E** compatibility identifier, or **F** controlled code migration. Contains the special reviews of `assertNoExchangeRuntime` (§5), `securities.token_trading` (§6) and the `exchange.*` namespace (§7), the four-state capability and five-environment model (§8), the Exchange module architecture assessment (§9) and the RWA→Exchange integration route (§10). Registers `MIG-001`…`MIG-010`. Raises `R6-Q1`. **DRAFT — ANALYSIS ONLY. Changes no lock, identifier, seeded row, migration, test or guard; authorises no migration; answers no regulatory question; approves no activity** | v0.1 | DRAFT | N/A | [`05_strategy/AIX_Capability_Lock_Review_v0.1.md`](05_strategy/AIX_Capability_Lock_Review_v0.1.md) | Unassigned | 2026-09-22 | N/A | none | 056a10f |
