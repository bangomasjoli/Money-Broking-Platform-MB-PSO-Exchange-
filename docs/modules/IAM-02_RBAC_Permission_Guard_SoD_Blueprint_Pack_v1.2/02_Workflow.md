...
12. Emit permission decision event where sensitive.
...
11. Approval stores payload hash and execution scope.
12. Approval cannot be executed unless payload hash is re-verified.
