...
| Item | Details |
|---|---|
| Document name | 02_Software_Requirement_Specification_v1.2.md |
| Platform | AIX Money Broking Platform |
| Document type | SDLC Phase 2 / Software Requirement Specification |
| Version | v1.2 |
| Status | Accepted for Role and Permission Matrix after document-control cleanup; no substantive requirement change from v1.1 |
