...
```txt
Review this IAM-02 RBAC / Permission Guard / SoD Blueprint Pack v1.0 as a principal fintech platform architect, regulated fintech security architect, IAM/RBAC architect, SoD reviewer, approval-control reviewer, and compliance reviewer.
...
- IAM-02 is the permanent authorization, maker-checker, permission guard, and SoD layer.
...
15. Missing API, DB, workflow, state-machine, permission, risk, test, or go-live controls.
16. Any IAM-02 feature that could bypass licence lock, audit, SoD, maker-checker, or enable Exchange/principal-dealing behaviour.
17. Any conflict with master docs 00–11, FND-01 v1.2, or IAM-01 v1.2.
