...
| Prohibited Feature Registry | Hard-blocked features/actions |
| Feature Policy Engine | Runtime allow/deny evaluation |
| Licence Lock Engine | Licence-level lock evaluation |
| Feature Decision Token Service | Short-lived feature decision evidence |
