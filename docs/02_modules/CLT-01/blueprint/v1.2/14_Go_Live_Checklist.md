...
| # | Gate | Status |
|---:|---|---|
| 1 | CLT-01 blueprint accepted | Complete |
...
| 21 | Security sign-off | Complete for blueprint acceptance |
| 22 | Compliance sign-off | Complete for blueprint acceptance |
| 23 | Management sign-off | Pending for implementation/go-live |
...
| # | Gate | Status |
|---:|---|---|
| 24 | CDD outcome gate defined | Pending |
| 25 | Handoff delivery/outcome separation defined | Pending |
| 26 | Authorised-party/UBO screening defined | Pending |
| 27 | Ongoing monitoring feedback defined | Pending |
| 28 | Periodic review scheduling defined | Pending |
| 29 | Verified class evidence gate defined | Pending |
| 30 | Handoff failure/dead-letter defined | Pending |
| 31 | Mandate schema validation defined | Pending |
| 32 | Authorised-user revocation propagation defined | Pending |
| 33 | Client uniqueness / related-party graph defined | Pending |
| 34 | Data-protection lawful basis / DSAR / retention model defined | Pending |
