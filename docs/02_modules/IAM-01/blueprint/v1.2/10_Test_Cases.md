...
| Test ID | Scenario | Expected Result | Priority |
|---|---|---|---|
| IAM1-TC-079 | `iam.auth_event` exists without SEC-01 audit ref | Critical defect / blocked | Critical |
| IAM1-TC-080 | Conflict between local auth_event and SEC-01 audit | SEC-01 audit authoritative | High |
| IAM1-TC-081 | Sensitive auth action without central audit | Fails closed / Critical defect | Critical |
