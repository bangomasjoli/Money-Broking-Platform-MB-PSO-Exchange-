...
| IAM2-RISK-016 | Approve-then-modify payload | Maker-checker bypass/fraud | Payload hash verified at execution | IAM2-TC-065 to 068 |
| IAM2-RISK-017 | Check-then-revoke TOCTOU | Revoked permission still executes | Decision token + cache version check | IAM2-TC-069/094 |
| IAM2-RISK-018 | Endpoint omits permission guard | Silent bypass | Protected-action registry | IAM2-TC-072 to 075 |
| IAM2-RISK-019 | SoD risk acceptance abused | SoD bypass | Critical block-only + dual approval | IAM2-TC-076 to 080 |
| IAM2-RISK-020 | Break-glass self-perpetuates | Durable privilege abuse | Whitelist/ceiling/duration/concurrency | IAM2-TC-081 to 085 |
| IAM2-RISK-021 | CFG/SEC dependency unavailable | Lock/audit drift | Interim sealed lock list + local non-authoritative audit | IAM2-TC-086 to 088 |
| IAM2-RISK-022 | Delegation chain abuse | Privilege expansion | Re-delegation prohibited | IAM2-TC-092 |
| IAM2-RISK-023 | Licence lock bypass via override | Licence breach | Lock precedence over override | IAM2-TC-093 |
...
11. Approval-to-execution binding.
12. Protected-action registry.
13. SoD risk acceptance controls.
14. Break-glass privilege ceiling.
15. Interim licence-lock/audit contracts.
16. Positive cache version checks.
