...
| # | Gate | Status |
|---:|---|---|
| 1 | LED-01 blueprint accepted | Complete |
...
| 30 | Compliance sign-off | Complete for blueprint acceptance |
| 31 | Security sign-off | Complete for blueprint acceptance |
| 32 | Management sign-off | Pending for implementation/go-live |
...
| # | Gate | Status |
|---:|---|---|
| 33 | Atomic reservation/live balance version defined | Pending |
| 34 | Snapshot reservation prohibited | Pending |
| 35 | Two-leg DvP model defined | Pending |
| 36 | Partial settlement/unwind path defined | Pending |
| 37 | Preventive safeguarding and encumbered backing defined | Pending |
| 38 | FX/cross-asset conversion event defined | Pending |
| 39 | Rounding/residual account policy defined | Pending |
| 40 | AIX net asset zero enforcement defined | Pending |
| 41 | Journal hash-chain defined | Pending |
| 42 | External anchoring defined | Pending |
| 43 | Hold pinning while in-flight defined | Pending |
| 44 | Post-credit clawback/reorg/fiat recall defined | Pending |
| 45 | Idempotency conflict behaviour defined | Pending |
| 46 | Operational/clearing/suspense/residual bounds defined | Pending |
| 47 | Fee settlement atomicity/compensation defined | Pending |
| 48 | Intraday safeguarding cadence defined | Pending |
