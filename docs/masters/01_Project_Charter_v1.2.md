...
| Item | Details |
|---|---|
| Document name | 01_Project_Charter_v1.2.md |
| Platform | AIX Money Broking Platform |
| Document type | SDLC Phase 1 / Project Initiation |
| Version | v1.2 |
| Status | Revised after Claude Opus Project Charter review; governance, custody, vendor, AI, delivery, and go-live gates added |
...
### 16.3 Charter Sign-Off Requirement
...
```txt
Review this 01_Project_Charter_v1.2.md as a principal fintech platform architect.
...
This version has added governance, custody/client-money safeguarding, vendors/dependencies, AI governance, delivery gates, missing modules, go-live assurance, and residual exchange/principal controls.
