...
| Item | Details |
|---|---|
| Document name | 06_Master_System_Rules_v1.1.md |
| Platform | AIX Money Broking Platform |
| Document type | SDLC Phase 2 / Master Rules and Control Logic |
| Version | v1.1 |
| Status | Revised after Claude Opus system-rules review; FX/precision, prohibited-asset categories, error set, encryption, reliability/BCP-DR, go-live assurance, input validation, SoD matrix enforcement, SOF/SOW, beneficial ownership, and EDD rules added |
...
### AML-RULE-001A Beneficial Ownership, SOF/SOW, and EDD Preconditions
...
13. Pen test passed or risk-accepted through formal approval.
...
```txt
Review this 06_Master_System_Rules_v1.1.md as a principal fintech platform architect and regulated fintech control/security reviewer.
