...
### 5.10 Break-Glass Is Exceptional
...
| Break-Glass Service | Emergency access workflow |
...
| Permission Reconciliation Job | Detects expired/conflicting grants |
...
| Permission revocation propagation | Required |
