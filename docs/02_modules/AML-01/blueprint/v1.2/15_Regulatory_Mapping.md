...
| AML-01 Control | Master Control / Rule Area | Tests |
|---|---|---|
| Pre-transaction sanctions gate | AML-RULE-001, SETTLE-RULE-001 | AML1-TC-044-045 |
| List update SLA/interim block | AML-RULE-001, OPS-RULE-001 | AML1-TC-046-048 |
| List coverage/freshness/matching quality | AML-RULE-001, VND-RULE-001 | AML1-TC-049, 053-054 |
| Ownership-based 50 percent sanctions | AML-RULE-001, KYC-RULE-001 | AML1-TC-050-051 |
| Screening input quality | AML-RULE-001, DATA-RULE-001 | AML1-TC-052 |
| STR statutory clock/pending transaction | AML-RULE-001, GOV-RULE-001 | AML1-TC-055-057 |
| Sanctions false-positive governance | AML-RULE-001, SOD-RULE-001 | AML1-TC-058-059 |
| Outcome seal/freshness | SEC-RULE-003, AML-RULE-001 | AML1-TC-060-061 |
| PEP/RCA/country/de-listing | AML-RULE-001 | AML1-TC-062-065 |
| Travel Rule threshold/sunrise | TRAVEL-RULE-001 | AML1-TC-066-067 |
