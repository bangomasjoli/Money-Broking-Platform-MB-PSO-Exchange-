...
### 5.3 GET `/kyc1/party-cases/{party_case_id}`
...
### 6.1 POST `/internal/kyc1/cases/{case_id}/compute-outcome`

Compute CDD outcome.

### 6.2 POST `/internal/kyc1/cases/{case_id}/publish-outcome`

Publish outcome to CLT-01.

### 6.3 GET `/internal/kyc1/cases/{case_id}/outcome`

Read outcome.

---

## 7. Periodic Review APIs

### 7.1 POST `/internal/kyc1/periodic-review/run`

Run periodic review job.

### 7.2 POST `/kyc1/cases/{case_id}/trigger-review`
...
### 8.1 POST `/kyc1/evidence-exports`

Request evidence export.

### 8.2 GET `/kyc1/evidence-exports/{export_id}`
