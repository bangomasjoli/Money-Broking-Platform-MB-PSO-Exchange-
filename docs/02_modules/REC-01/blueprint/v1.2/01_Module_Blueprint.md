...
v1.1 resolved:
1. SEC/E2E authoritative population denominator.
2. Full-population coverage proof.
3. Monotonic per-module sequence gap detection.
4. Consistent LED/E2E as-of snapshot model.
5. In-flight / expected-open reconciling item class.
6. External statement authenticity, completeness, freshness and independence controls.
7. All-safeguarding-accounts completeness check.
8. REC run / break / report hash-chain and external anchoring.
9. Mandated scope enforcement.
10. No selective scoping / no selective blinding.
11. Reconciliation function independence and SoD.
12. Safeguarding four-eyes sign-off.
13. High / critical break closure requires clean re-reconciliation.
14. Break recurrence detection.
15. False-positive independent sign-off.
16. Repeated close / reopen senior escalation.
17. Materiality / tolerance governance.
18. Zero-tolerance classes protected.
19. Severity mapping governance.
20. Reconciliation rule-change control.
21. Controlled report restatement workflow.
22. Regulatory obligation and filing deadline tracker.
