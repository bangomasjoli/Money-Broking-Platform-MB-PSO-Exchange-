...
| # | Gate | Status |
|---:|---|---|
| 1 | WLT-01 blueprint accepted | Complete |
...
| 27 | Security sign-off | Complete for blueprint acceptance |
| 28 | Compliance sign-off | Complete for blueprint acceptance |
| 29 | Management sign-off | Pending for implementation/go-live |
...
| # | Gate | Status |
|---:|---|---|
| 30 | Execution-time verify-and-consume contract defined | Pending |
| 31 | Revocation epoch/version binding defined | Pending |
| 32 | Per-destination/client limits defined | Pending |
| 33 | Velocity and concentration controls defined | Pending |
| 34 | New-destination first-use control defined | Pending |
| 35 | Inbound source screening defined | Pending |
| 36 | Deposit quarantine / mis-attribution guard defined | Pending |
| 37 | Unhosted proof-of-control defined | Pending |
| 38 | Wallet own-name / KYC beneficiary binding defined | Pending |
| 39 | Chain-specific canonicalisation rules defined | Pending |
| 40 | Name-service resolution policy defined | Pending |
| 41 | Address-poisoning protection defined | Pending |
| 42 | Supported chain/provider coverage defined | Pending |
| 43 | AML revocation subscription defined | Pending |
| 44 | Cooling-off new-risk cancellation defined | Pending |
