...
| CLT-01 Control | Master Control / Rule Area | Tests |
|---|---|---|
| CDD/screening/risk outcome gate | AML-RULE-001, KYC-RULE-001 | CLT1-TC-042-047 |
| Authorised-party/UBO screening | AML-RULE-001, KYC-RULE-001 | CLT1-TC-048-052 |
| Ongoing monitoring/perpetual KYC | AML-RULE-001, KYC-RULE-001 | CLT1-TC-053-057 |
| Verified class evidence | LIC-RULE-001, CFG-RULE-001 | CLT1-TC-058-059 |
| Verified identity uniqueness / related-party graph | AML-RULE-001, GOV-RULE-001 | CLT1-TC-060-061 |
| Data protection / mandate schema | DATA-RULE-001, SOD-RULE-001 | CLT1-TC-062-065 |
