...
| ARC-03 | Master Module Index | Platform-wide | Module index / build order — re-baselined for the four-product institutional platform. **Resolves the two-taxonomy collision** recorded in `STR-01` §2.5: implementation module codes are now the sole identifiers and v1.2's conceptual groups are demoted to descriptive capability groups. 33 modules — all 17 accepted/blueprinted IDs retained unrenumbered, 16 new (ACC-01, AST-01, FEE-01, TRE-01, OMS-01, MKD-01, LQD-01, EXE-01, SUR-01, PAY-01, RWA-01..04, API-01, RPT-01). Includes dependency-derived build sequence, dependency rules and parallel-development ownership rule. No internal-matching module exists or may be created | v1.3 | APPROVED | N/A (governance doc) | `01_masters/03_Master_Module_Index_v1.3.md` | Unassigned | N/A | Internally reviewed against approved Doc 00 v1.4, Charter v1.4, `DEC-011` and `DEC-012` | v1.0, v1.1, v1.2 (archived) | 53d1e3a |
