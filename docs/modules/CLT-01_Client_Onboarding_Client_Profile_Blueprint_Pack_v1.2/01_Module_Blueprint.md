...
v1.1 resolved the CDD outcome gate, authorised-party screening, ongoing monitoring feedback, verified-class evidence gate, data-protection depth, handoff failure handling, mandate schema validation, revocation propagation, verified-identity uniqueness, and related-party graph controls.
