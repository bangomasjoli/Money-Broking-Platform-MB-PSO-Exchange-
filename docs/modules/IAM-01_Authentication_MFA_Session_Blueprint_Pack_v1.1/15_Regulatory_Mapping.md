...
| Session security | IAM-RULE-001, SEC-RULE-003 | IAM1-TC-028 to 036, IAM1-TC-066 to 073 |
| Rate limiting | SYS-RULE-005 | IAM1-TC-004, IAM1-TC-037, IAM1-TC-076, IAM1-TC-077 |
| Audit events | SEC-RULE-001, SEC-RULE-002 | IAM1-TC-007, IAM1-TC-049 to 051, IAM1-TC-079 to 081 |
...
| Step-up authentication | IAM-RULE-001, SEC-RULE-003, PAY-RULE-001, PAY-RULE-002 | IAM1-TC-055 to 060 |
| Freeze/suspension session revocation | FRZ-RULE-001, FRZ-RULE-002, IAM-RULE-001 | IAM1-TC-061 to 065 |
| Password history / breached password | SEC-RULE-003, DATA-RULE-001 | IAM1-TC-074/075 |
...
| WF-IAM01-04 Step-Up Authentication | IAM1-TC-055 to 060 |
...
| WF-IAM01-11 Freeze Session Revocation | IAM1-TC-061 to 065 |
| WF-IAM01-12 Mid-Session Anomaly | IAM1-TC-069/070 |
| WF-IAM01-13 Global Logout / Concurrent Sessions | IAM1-TC-071 to 073 |
...
|---|---|---|
| DF-23 Auth/Session/MFA | Login, MFA, step-up, session, token lifecycle | IAM1-TC-001 to 048, IAM1-TC-055 to 073 |
...
| Audit/outbox flow | Auth audit events and SEC-01 authority | IAM1-TC-049 to 051, IAM1-TC-079 to 081 |
...
8. Sensitive-action step-up controls for money modules.
9. Immediate freeze/suspension revocation support.
10. Privileged session hardening.
