...
**Available blueprint versions:** v0.1, v0.2, v0.3
**Authoritative blueprint version:** none — v0.1, v0.2 and v0.3 are **planning packs**, not certified. [DOCUMENT_REGISTER.md](../../DOCUMENT_REGISTER.md) is the sole authority for blueprint version and status; this README does not decide it, and no register row has been added (out of this task's ownership — see dependency request DCR-ACC-GOV-01).
**Blueprint status:**
...
| **v0.3** | **REMEDIATED / AWAITING RE-REVIEW** — remediates R2-F01…R2-F09 and records ACC-R2-HD-01…08 ([`05-remediation-r2.md`](../../03_implementation/tasks/ACC-01/05-remediation-r2.md)); **not yet re-reviewed — separate-context re-review required** |
...
Current pack: [`blueprint/v0.3/`](blueprint/v0.3/) — start at its [README](blueprint/v0.3/README.md). Historical (reviewed, REMEDIATE, unchanged): [`blueprint/v0.2/`](blueprint/v0.2/) and [`blueprint/v0.1/`](blueprint/v0.1/).

Task record: [`../../03_implementation/tasks/ACC-01/`](../../03_implementation/tasks/ACC-01/) (`01-plan.md`, `04-review.md`, `05-remediation.md`, `04-review-r2.md`, `05-remediation-r2.md`, `task.json`).
...
- v0.3 — **awaiting separate-context re-review**.
...
Dependency-change requests (`DCR-ACC-*`, classified ACC-BUILD / ACC-REAL-USE / LED-DESIGN / GO-LIVE / GOV), open questions (`OQ-*`) and human decisions are recorded in [`blueprint/v0.3/17_Dependency_Change_Requests_And_Open_Questions.md`](blueprint/v0.3/17_Dependency_Change_Requests_And_Open_Questions.md). **No dependent module has changed.** Operation of ACC-01 depends on environment-agnostic `DEP-*` prerequisites (headed by `IAM2-FIND-002` and the IAM-02 actor-binding contract); **environment availability belongs to CFG-01**, not ACC-01. Findings are owned by [OPEN_FINDINGS.md](../../OPEN_FINDINGS.md); this pack raises none itself — a human promotes.
