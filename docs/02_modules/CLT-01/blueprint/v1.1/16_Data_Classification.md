...
## v1.1 Data Protection Additions

Additional protected data:

| Data | Classification | Protection |
|---|---|---|
| CDD outcome aggregate | Restricted / Compliance Sensitive | Outcome refs, not raw screening content |
| Authorised party / UBO | Restricted / Personal Data | Screening and mandate control |
| Monitoring feedback | Restricted / Compliance Sensitive | Status control |
| Related-party graph | Restricted / Compliance Sensitive | AML access control |
| Verified identity hash | Restricted / Security Critical | Privacy-preserving uniqueness |
| Data-protection request | Restricted / Legal | Access controlled |
| Retention schedule | Restricted / Legal | Approved policy |

Additional rules:

1. Lawful basis mapped by data class.
2. AML/regulatory retained records are not deleted before retention basis expires.
3. Erasure may result in restriction/pseudonymisation rather than deletion.
4. Cross-border storage/transfer basis must be defined for PSO/client data.
5. Downstream rectification/restriction notices are required where data is copied.
