...
```txt
Review this AML-01 Sanctions / PEP / Adverse Media / Travel Rule Screening Blueprint Pack v1.1 as a principal fintech platform architect, regulated fintech AML/CFT architect, sanctions-screening control reviewer, Travel Rule reviewer, STR/tipping-off reviewer, and security governance reviewer.
