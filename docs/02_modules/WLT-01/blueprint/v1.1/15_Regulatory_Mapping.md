...
| WLT-01 Control | Master Control / Rule Area | Tests |
|---|---|---|
| Execution-time revalidation | FUND-RULE-001, SEC-RULE-003 | WLT1-TC-041-044 |
| Destination/client limits | MON-RULE-001, FUND-RULE-001 | WLT1-TC-045-047 |
| Inbound source screening/quarantine | AML-RULE-001, SAFEGUARD-RULE-001 | WLT1-TC-048-051 |
| Unhosted proof-of-control | AML-RULE-001, TRAVEL-RULE-001 | WLT1-TC-052-054 |
| Address canonicalisation/poisoning | SEC-RULE-003, FUND-RULE-001 | WLT1-TC-055-057 |
| Supported chain/provider coverage | VND-RULE-001, AML-RULE-001 | WLT1-TC-058, 061 |
| AML revocation subscription | AML-RULE-001, SYS-RULE-001 | WLT1-TC-059, 069 |
| Cooling-off new-risk cancellation | AML-RULE-001, FRAUD-RULE-001 | WLT1-TC-060, 063 |
