...
const config: Wlt1Config = {
  ...
  // Public Perimeter / Pre-Authentication Abuse Control (DEC-010) — this file exercises only the
  // internal `/internal/wlt1/*` surface, so the public surface stays disabled (safe default).
