...
v1.1 resolved:
1. Credit-request coherent WLT + AML + confirmation bundle revalidation.
2. AML-01 / WLT-01 revocation subscription for in-flight deposits.
3. Pullback to quarantine before LED credit if screening is stale or revoked.
4. Inbound source-of-funds / own-source binding.
5. KYC-verified own account / wallet matching.
6. Third-party / unexpected source SoF review.
7. SoF / SoW evidence for large or first deposits.
8. Per-source finality model.
9. Crypto reorg-depth and multi-source corroboration.
10. Fiat return / recall window awareness.
11. Provider identity-bound receipt authentication.
12. File-feed completeness and missing-sequence detection.
13. Independent bank / chain / custodian truth reconciliation.
14. Unique-per-intent reference / address policy.
15. Expired or cancelled intent deposit quarantine.
16. Partial / over / under / dust amount disposition.
17. Inbound Travel Rule capture.
18. LED pending orphan control.
19. Controlled return path through WLT / AML / LED payout controls.
20. Credit-time client eligibility recheck.
21. Reversal events bind original correlation and saga.
