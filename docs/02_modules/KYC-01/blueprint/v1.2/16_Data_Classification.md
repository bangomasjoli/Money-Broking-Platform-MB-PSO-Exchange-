...
## v1.1 Data / Evidence Store Additions

Additional protected data:

| Data | Classification | Protection |
|---|---|---|
| UBO look-through tree | Restricted / Compliance Sensitive | AML/KYB access only |
| Trust/nominee role data | Restricted / Compliance Sensitive | High protection |
| Vendor reliance record | Restricted / Security Critical | Approval/audit |
| Proofing assurance policy/result | Restricted / Compliance Sensitive | Integrity protected |
| Liveness/biometric binding result | Restricted / Biometric/Sensitive | Strong access control; reference/minimise |
| SoW/SoF evidence ref | Restricted / Compliance Sensitive | EDD access only |
| Evidence-store hash verification | Security Critical | Tamper evidence |
| Verified identity hash basis | Security Critical | CLT-aligned |

Evidence-store contract:

1. encryption at rest required.
2. IAM-02-bound access control required.
3. hash re-verification on read/export/outcome use required.
4. retention/destruction aligned to CLT-01.
5. raw documents remain in approved evidence store, not ordinary profile tables.
