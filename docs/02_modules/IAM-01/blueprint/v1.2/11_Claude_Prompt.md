...
```txt
Review this IAM-01 Authentication / MFA / Session Blueprint Pack v1.2 as a principal fintech platform architect, regulated fintech security architect, authentication architect, and QA reviewer.
...
- FND-01 Platform Foundation Pack v1.2 is accepted and must be inherited.
...
Follow accepted FND-01 v1.2 patterns.
```
