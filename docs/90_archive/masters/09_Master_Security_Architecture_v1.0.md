...
| Item | Details |
|---|---|
| Document name | 09_Master_Security_Architecture_v1.0.md |
| Platform | AIX Money Broking Platform |
| Document type | SDLC Phase 2 / Master Security Architecture |
| Version | v1.0 |
| Status | Initial master security architecture for review |
...
## 5. Identity and Authentication Security
...
| Admin / Super Admin | Password + strong MFA required |
| Security / Tech Admin | Password + strong MFA required |
...
### 7.3 Staff Portal Cross-Client Access
...
### 9.3 Rate Limiting and Abuse Protection
...
## 10. Encryption, Key, and Secret Management
...
## 11. Inbound Webhook and Vendor Security
...
### 11.3 Vendor Credential Security
...
### 11.4 Outbound Vendor Data Minimisation
...
## 12. Ledger, Money Movement, and Client-Money Security

### 12.1 Ledger Security
...
### 12.4 LP Settlement Payment Security
...
## 13. Quote, LP, and Exchange-Lock Security
...
### 13.2 Agency Execution Security
...
## 14. Compliance, AML, Travel Rule, and STR Security

### 14.1 KYC/KYB Security
...
### 14.4 Wallet Screening Security
...
## 15. Audit, Logging, and Monitoring Security
...
## 16. Privacy, Data Protection, and Records Security
...
## 17. File Upload and Document Security

### 17.1 Upload Controls
...
## 18. Break-Glass and Incident Security

### 18.1 Break-Glass Access
...
## 19. Backup, DR, and Business Continuity Security
...
## 20. CI/CD and Environment Security
...
## 21. Future-Locked Exchange Security Exclusion
...
16. DR runbook approved.
17. Monitoring and alerting active.
18. Incident response runbook approved.
19. Data residency approved.
20. Exchange-locked modules disabled verified.
21. Production deployment maker-checker approved.
22. Compliance/MLRO sign-off.
23. Management/Principal Officer sign-off.
...
9. Dormant users.
10. Privileged permissions.

### 24.2 Vulnerability Management
...
## 28. Module Blueprint Security Requirements
...
## 29. Claude Model Usage

### 29.1 Planning Model / ChatGPT 5.5
...
## 30. Claude Opus Review Prompt

```txt
Review this 09_Master_Security_Architecture_v1.0.md as a principal fintech platform architect and regulated fintech security reviewer.
