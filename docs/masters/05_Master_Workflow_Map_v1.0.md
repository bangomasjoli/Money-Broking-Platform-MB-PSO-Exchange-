...
| Item | Details |
|---|---|
| Document name | 05_Master_Workflow_Map_v1.0.md |
| Platform | AIX Money Broking Platform |
| Document type | SDLC Phase 2 / Master Workflow Control |
| Version | v1.0 |
| Status | Initial master workflow map for review |
...
| WF-26 | Future-Locked Exchange Workflow |
...
| 2 | System checks destination type | System | Bank or wallet |
| 3 | Ownership evidence collected | Client | Own-name requirement |
| 4 | Wallet screening triggered where wallet | System | Blockchain analytics |
| 5 | Travel Rule linkage prepared where applicable | System | Travel Rule |
| 6 | Ops / Finance / Compliance reviews | Ops / Finance / Compliance | Maker |
| 7 | Checker approves | Ops Manager / Finance Manager / Compliance | Checker |
| 8 | Cooling-off period starts | System | Configured threshold |
| 9 | Destination becomes active after cooling-off | System | Audit log |
| 10 | Withdrawal can use destination | System | Backend guard |
...
4. Wallet screening is high-risk and unresolved.
5. Travel Rule data is missing where required.
6. Cooling-off period has not passed.
7. Maker-checker approval is missing.
...
| 3 | Deposit matched to client | Ops / Finance | Maker |
| 4 | Compliance hold checked | System / Compliance | AML rules |
| 5 | Deposit approved for credit | Ops/Finance + Checker | Maker-checker |
| 6 | Ledger posts client money credit | Ledger Service | Double-entry |
| 7 | Client balance updates | System | Atomic ledger/balance |
| 8 | Reconciliation updated | System | Bank vs ledger |
| 9 | Safeguarding computation updates | System | Full-backing invariant |
...
2. Deposit cannot be matched.
3. AML/compliance hold exists.
4. Ledger posting fails.
5. Reconciliation rule fails.
6. Crediting would create incorrect safeguarding computation.
...
| 6 | Custodian receipt confirmed | System | Custodian evidence |
| 7 | Ledger credit posted | Ledger Service | Double-entry |
| 8 | Client balance updated | System | Atomic ledger/balance |
| 9 | Reconciliation updated | System | Custodian vs ledger |
...
4. Custodian receipt is not confirmed.
5. Compliance hold is active.
...
## 30. WF-26 Future-Locked Exchange Workflow
...
## 31. Cross-Workflow Dependency Map
...
| Client-Money Safeguarding | Go-Live Gate, Finance/Compliance Reports |
| Transaction Monitoring | AML Case |
| Travel Rule / Wallet Screening | Withdrawal, Deposit, AML Case |
...
## 32. Master Workflow State Requirements
...
## 33. Master Audit Event Requirements
...
## 35. Testing Requirements for Workflows
...
## 36. Open Items for Module Blueprints
...
## 38. Claude Opus Review Prompt

```txt
Review this 05_Master_Workflow_Map_v1.0.md as a principal fintech platform architect and regulated fintech workflow/security reviewer.
