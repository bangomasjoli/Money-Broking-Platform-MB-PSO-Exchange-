...
> source PDFs. **No element is now excepted:** the post-trade half of LFSA-DMB-2025 ¶5.9 has been
> verified against the final published guideline and its earlier ‡ marker is withdrawn.
...
| LFSA-DMB-2025 | **5.9** | **Both pre-trade and post-trade information must be accessible during normal trading hours.** *Pre-trade:* current bid prices, current offer prices, available asset volume, depth of trading interest, relevant communication methods. *Post-trade:* price, trade time, volume of completed transactions, **disclosed as close to real-time as technically feasible** |
...
| **R3-Q2a** | May AIX **display** aggregated bid/offer/volume/depth? | **CLOSED_BY_REGULATORY_EVIDENCE** — LFSA-DMB-2025 ¶5.9 makes current bid, current offer, available volume, **depth of trading interest** and relevant communication methods part of required pre-trade information, **and post-trade price, trade time and volume of completed transactions disclosed as close to real-time as technically feasible**, both accessible during normal trading hours. Display is not merely permitted but **expected** |
